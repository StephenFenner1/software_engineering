 ...
 * @author Group 26
 */
public class IntelligentTraderJUnitTest {
     ...
     * needed to create a new instance of IntelligentTrader.
     */
    public IntelligentTraderJUnitTest() {
        ...
        traderA = new IntelligentTrader();
        traderB = new IntelligentTrader();
     ...
     * should produce "Intelligent"
     */
    @Test
    public void getType() {
        testGetIDFirst();
        assertEquals(traderA.getType(), "Intelligent");
        assertEquals(traderB.getType(), "Intelligent");
    }

    /**
     * Tests the getter method for the mood of the Trader. In this instance it
     * should produce "N/A"
     */
    @Test
    public void getMood() {
        testGetIDFirst();
        assertEquals(traderA.getMood(), "N/A");
        assertEquals(traderB.getMood(), "N/A");
    }
