...
/**
 * Setup class for the user interface.
 * 
 * @author Jah
 */
public class Setup extends javax.swing.JFrame {
    ...
    /**
     * Constructor method for the UI setup class. Calls the initComponents method 
     * to allow the user to initialise the simulation.
     */
    public Setup() {
        Object[] temp;
    ...
    /**
     * Handles users clicking on the client button. Makes the client panel visible
     * and both the trading exchange and stock panels not visible.
     * 
     * @param evt   The clicked mouse event.
     */
    ...
    /**
     * Handles users clicking on the trading exchange button. Makes the trading exchange 
     * panel visible and both the client and stock panels not visible.
     * 
     * @param evt   The clicked mouse event.
     */
    ...
    /**
     * Handles users clicking on the companies button. Makes the stocks
     * panel visible and both the trading exchange and client panels not visible.
     * Also creates the companies table. Displaying information on the companies,
     * such as their name, stocktype, stockvalue and whether they're bankrupt or not.
     * 
     * @param evt   The clicked mouse event.
     */
    ...
    /**
     * Creates an option form for the user to decide whether the selected client
     * will cash out or not. If yes is selected, cashing out is set to true for
...
//    }
    ...
    /**
    * Initial setup for the simulation. Creates a window for the user to interact 
    * with. The user will choose a file for both the company and client.The user will 
    * also decide on the amount of traders.
    */
    ...
    /**
     * Setter method for the compFile
     * 
     * @param file the new compFile.
     */
    ...
    /**
     * Setter method for the clientFile
     * 
     * @param file the new clientFile.
     */
    ...
    /**
     * Getter method to get both the company and client files.
     * 
     * @return an array of both the company and client files.
     */
    public File[] getFile() {
    ...
    /**
     * Getter method for the number of traders.
     * 
     * @return returns the number of traders in the simulation. 
     */
    ...
    /**
     * Setter method for the companies arraylist.
     * 
     * @param companies The new companies arrayList. 
     */
    ...
    /**
     * Setter method for the portfolios arrayList
     * 
     * @param portfolios The new portfolios arrayList
     */
